...
router.get('/api/cashflows/distributions', (request, result, next) => {
    db.query('SELECT "tblIDB_Investments_CF"."ID", "tblIDB_Investments_CF"."InvID","tblIDB_Investments_CF"."CID", "tblIDB_Investments_CF"."Scenario", "tblIDB_Investments_CF"."CFID"'+
