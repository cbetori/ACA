...
//Other State
    ...
    //Modal
        ...
        function handleOk () {
            ...
            setTimeout(() => {
                updateInvestorCashFlow(newModalValue)
                setVisible(false)
            ...
            <div style={{background: '#ECECEC'}}>
                ...
                <Modal
                    ...
                    >
                        ...
                        <Input onChange={(e)=> updateModalValues({InvID: parseInt(e.target.value)})} id="InvID" addonBefore='InvID' defaultValue={oldModalValues.InvID}/>
                        <Input onChange={(e)=> updateModalValues({CID: parseInt(e.target.value)})} style={{margin: 5}} addonBefore='CID' defaultValue={oldModalValues.CID}/>
                        </div>
                        <Input onChange={(e)=> updateModalValues({Code_Name: e.target.value})} style={{margin: 5}} addonBefore='Type' defaultValue={oldModalValues.Code_Name}/>
                        <Input onChange={(e)=> updateModalValues({CF_Date: e.target.value})} style={{margin: 5}} addonBefore='Date' defaultValue={oldModalValues.CF_Date}/>
                        <Input onChange={(e)=> updateModalValues({CF_Amount: numeral(e.target.value)._value})} style={{margin: 5}} addonBefore='Amount' defaultValue={oldModalValues.CF_Amount}/>
                </Modal>
